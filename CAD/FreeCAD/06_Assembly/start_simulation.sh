...
echo ""
echo "NC dosyası oynatımı için:"
echo "  result = run_nc_file_simulation(App.ActiveDocument, '${SCRIPT_DIR}/../../Firmware/NC300/GCode/Standard_Cut.nc')"
echo "  export_nc_simulation_report(result)"
echo ""
echo "========================================"
echo ""
