...
**Not 1:** `U2 / DOP-110CS` operator terminali ana pano icinde veya pano kapaginda degildir. Uzak operatör terminali olarak, koprunun home noktalarina yakin saha tasiyici/ayak uzerine monte edilecektir.

**Not 2:** `U1 / NC300` pano disindan servis ve operator erisimi icin ana pano kapagina monte edilecektir. Ekran/servis portlari kapak acilmadan ulasilabilir olmalidir.
...
|   |                        DIN RAY 4 (1600 mm)                       |     |
|   +------------------------------------------------------------------+     |
|   |   X12 (AUX)    |   S2 (RESET)   |               |   X1 AC IN    |     |
|   |   5-pin AUX    |   NO + LED      |               |   5-pin AC    |     |
|   +------------------------------------------------------------------+     |
|                                                                            |
+============================================================================+
```

### 2.1 Pano Kapagi Uzerindeki Bilesen

| Ref | Bilesen | Konum | Not |
|-----|---------|-------|-----|
| U1 | Delta NC300 CNC Controller | Ana pano kapaginin operatora bakan orta-sag bolgesi | Ekran/portlara kapak acilmadan erisim |
...
| **KAPAK MONTAJLI KONTROL** |
| U1 | NC300 CNC Controller | Pano kapagi, orta-sag | Yaklasik 320x220x90 | Kapak | Disaridan erisilebilir servis/operator kullanimi |
| **I/O SISTEMI** |
...
| S0 | E-STOP Buton | U2 operator terminali on yuzu | 40mm | Operator panel | Mantar kirmizi, operatorden dogrudan erisim |
...
- **NC300 Montaji:** NC300 pano kapaginda, disaridan ulasilabilir bolgede konumlanacak; kapak kablo gecisi hareketli kablo korumasi ile korunacak
