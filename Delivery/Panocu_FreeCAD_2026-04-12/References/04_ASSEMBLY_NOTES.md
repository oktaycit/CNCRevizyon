...
20. **NC300 Controller (U1)**
    - Konum: ana pano kapaginin operatora bakan erisilebilir bolgesi
    - Kapak acilmadan ekran/servis portlarina ulasilabilmeli
    - HMI Ethernet bağlantısı
    - EtherCAT master portları
    - Kapak ile govde arasinda hareketli kablo korumasi kullanin
...
30. **NC300 kapak montaji**
    - NC300 kullanici/servis erisimi icin pano kapagina alinacak
    - Kablo bukunme yaricapi kapak hareketine uygun secilecek
    - Kapak ilede, govde ilede konektor ve PE baglantisi servis kolayligi dikkate alinarak duzenlenecek

31. **E-STOP operator terminal montaji**
    - `S0` acil stop butonu ana pano yerine operator terminali uzerinde olacak
    - Operatörun elinin dogal ulasacagi alt-sag veya yan-on bolgede konumlandirin
    - Buton: 40mm mantar tip, 2NC, sarı taban / kirmizi baslik
