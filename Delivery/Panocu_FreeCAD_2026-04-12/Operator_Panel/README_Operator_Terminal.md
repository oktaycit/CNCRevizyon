...
**Güncelleme:** Ayakli operator terminal formu eklendi

---

## 📋 Genel Bilgi

Bu FreeCAD modeli, LiSEC GFB-60/30RE cam kesim makinesinin operatör kontrol terminali için tasarlanmıştır. Tasarim dili, LiSEC makine operator istasyonlarinin saha ergonomisini ve Beckhoff endustriyel panel ailesinin sade, ince cerceveli gorunumunu referans alir. Terminal; ayakli, kolonlu ve operatora hafif egimli bir ust basliktan olusur.
...
- **Ayakli terminal formu** ile makineden bagimsiz saha montaji
- **Ince cerceveli panel basligi** ile Beckhoff benzeri temiz gorunum
...
| Özellik | Değer |
|---------|-------|
| Tip | Ayakli operator terminali |
| Form | Agir taban + kablo kolonu + one egimli terminal basligi |
| Ergonomi | Home noktalarini goren operator pozisyonu |
| Stil | LiSEC saha kullanimi + Beckhoff panel dili |

### Terminal Başlığı

| Özellik | Değer |
|---------|-------|
| Dış Ölçüler | 420 x 340 x 220 mm (G x Y x D) |
| Duvar Kalınlığı | 5 mm |
| Malzeme | Boyalı sac çelik / Paslanmaz çelik |
| Koruma Sınıfı | IP65 |
| Ağırlık (tahmini) | ~7-9 kg |
...
|---------|-------|
| Taban | 520 x 420 mm |
| Kolon | 150 x 110 mm kesit, kablo gizlemeli |
| Kolon Yüksekliği | ~1080 mm |
| Baslik Tasiyici | One cikan destek blogu |
| HMI merkez seviyesi | Yaklasik 1100-1200 mm |
...
| `Operator_Terminal_Enclosure.stp` | Terminal basligi ana govde | ~150 KB |
| `Operator_Terminal_Door.stp` | Terminal basligi on kapagi | ~120 KB |
...
| `Operator_Terminal_Complete.stp` | Ayakli tam montaj | ~300 KB |

### Form Notu

Bu versiyonda terminal artik duvara veya makine sacina bagli kutu gibi degil; bagimsiz ayakli operatör istasyonu gibi ele alinmistir. Bu sayede:

- koprunun home bolgesine daha yakin konumlanabilir
- operator gorus acisi iyilesir
- kablo rotasi kolon icinde gizlenebilir
- panocu icin sac imalat formu daha net tanimlanir
