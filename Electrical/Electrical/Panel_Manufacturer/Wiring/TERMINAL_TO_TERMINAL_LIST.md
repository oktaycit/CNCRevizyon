...
|--------|-------|---------|----------|
| `F2 OUT` | `X2.1` | W004 | NC300 sigortali +24V dagitimi |
| `0V BUS` | `X2.2` | W006 | 0V ortak dagitim |
| `X2.1` | `U1 NC300 +24V` | W005 | NC300 besleme |
| `X2.2` | `U1 NC300 0V` | W006A | NC300 0V |
| `F6 OUT` | `X2.3` | W008 | HMI sigortali +24V saha cikisi |
| `0V BUS` | `X2.4` | W006B | HMI 0V saha cikisi |
| `X2.3` | `U2 DOP +V` | W008A | Uzak HMI +24V |
| `X2.4` | `U2 DOP -V` | W009 | Uzak HMI 0V |
| `F3 OUT` | `X2.5` | W011 | R1-EC sigortali +24V dagitimi |
| `X2.6` | `U50 R1-EC GND` | W012 | R1-EC 0V |
| `F4 OUT` | `X2.7` | W016 | AUX/Sensor +24V dagitimi |
| `X2.8` | `X12.2` | W017 | AUX 0V dagitimi |
...
| `U1 CN3` | `U2 ETH` | W308 | Uzak HMI Ethernet |
...
| `U53 DO_7` | `X40.8` | W457 | Kirici enable |
| `U53 DO_10` | `X40.11` | W458 | Konveyor ileri |
| `U53 DO_11` | `X40.12` | W459 | Konveyor geri |
